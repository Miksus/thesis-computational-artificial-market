...
as the execution system for the model built in this thesis. On the other hand, %TODO Supervisor: Tama oletus voidaan mainita tassa --> muista esittaa se myos mallin tarkemman esittelyn yhteydessa
...
This algorithm is illustrated in algorithm ~\ref{alg:lob_cont}. %TODO Supervisor: Jos mahdollista tahan olisi hyva saada viittaus kirjallisuuteen esim: "The interested reader should refer to xxx (yyyy)"
...
\begin{enumerate}
    %TODO Supervisor: Kuvio, tarkasteluvalin y akselin n=? 
    ...
    \end{minipage}
    %TODO Supervisor: Kuvio, mika on x ja y kuviossa? Mika on sininen pilvi kuvioissa?
    ...
    \end{minipage}
    %TODO Supervisor: Kuvio, Sama kuin ylempi
