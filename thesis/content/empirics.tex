...
an artifical stock market and therefore to contribute to the literature %TODO Supervisor: This is important and should be highlighted in research questions: "therefore to contribute to the literature the actual structure of the market is explained in depth"
...
The ASM model has three layers: abstraction layer, concrete %TODO Supervisor: Tahan voisi lisata illustrative kuvan, jossa nakyy yhteydet layereiden valilla ja tarkeimmat toiminnot
...
traders. The reason for this is to minimize the degrees of freedom introduced with %TODO Supervisor: Tutkimuskysymys: "miten rakentaa geneerinen malli?" --> tassa voisi viitata, etta tutkimuksen tavoitteiden mukaisesti tehdaan mahdollisimman geneerinen
...
is show in ~\ref{fig:generated_orders}. The figure contains simulation %TODO Supervisor: Kuva talle sivulle -> voi olla vaikka kappaleen yli jos vaikea mahduttaa jarkevasti
...
All quantities of the assets are stored as integers to prevent wealth leakage %TODO Supervisor: Esim. taman asian mallinnusta voisi tarkastella suhteesa kirjallisuuteen "All quantities of the assets are stored as integers"
...
the simplest solution to avoid this while still having integers for quantities %TODO Supervisor: Vahan viittaus edelliseen: Miten ratkaistu kirjallisuudessa (" simplest solution to avoid")
