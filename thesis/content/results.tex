...
The model was tested in several experiments. First, the generic dynamics of %TODO Supervisor: Perustele, miksi tutkit juuri nailla valituilla simulaatioajoilla -> onko kirjallisuudessa jokin yleisesti kaytetty metodi, jonka kanssa nama ovat vertailukelpoisia yms.
...
\begin{figure}
    ...
    \caption{Evolution of price and quantity} %TODO Supervisor: Tama voisi olla ylemmalla
...
\subsubsection{Model Validation with Stylized Facts} %TODO Supervisor: --> "Simulating Stylized Facts"? Answer: Changed.
% stylized facts
...
\begin{figure}
    ...
    \caption{Autocorrelation of the simulation} %TODO Supervisor: Selita akselit, sama alemmalla
